...
from _users_data import USERS_CONFIG, SERVER
from _merge_data import MERGE_BRANCHES
...
if __name__ == '__main__':
    #try:
        start()
    #finally:
    #    smtp.send_email(u"desenv.1dl@gmail.com", u"desenv1dl", [u"desenv.1dl@gmail.com"], log_path)
